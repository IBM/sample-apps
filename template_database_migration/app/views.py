...
QRadar Sample app showing how to host a PostgreSQL database with Flyway migration management
in a QRadar app.
"""
__author__ = "IBM"
...
def addFruit():
    ...
    try:
        ...
        cur.execute("INSERT INTO fruit (name, color) VALUES (%s, %s)", [fruit, color])
